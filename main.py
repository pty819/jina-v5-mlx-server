...
def main():
    ...
    serve_parser.add_argument("--idle-seconds", type=int, default=1200, help="Unload embedding/rerank models after N seconds idle (default: 1200)")
    serve_parser.add_argument("--max-chat-queue-size", type=int, default=32, help="Maximum queued chat completion requests")
    serve_parser.add_argument("--mlx-cache-limit-mb", type=int, default=0, help="MLX free cache limit in MB for embedding/rerank serving (default: 0)")
